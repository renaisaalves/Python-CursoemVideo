...
if idade < 18:
    ...
    print('De acordo com a sua idade ({}), você ainda vai se alistar.' .format(idade))
    ...
    print('De acordo com a sua idade ({}), já está na hora exata de se alistar.' .format(idade))
else:
    diferenca = idade - 18
    falta = atual - diferenca
    print('De acordo com a sua idade ({}), já passou do tempo do seu alistamento.' .format(idade))
